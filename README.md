# Material UI based geo search app /react/redux/startkit - Nik
## What does this app do
 * Search geo locations based on name ,address and tags
 * Used ES6, redux, reducer, react router and webpack
 * React Material UI and Flex layout
 * Express node server and sample JSON file
